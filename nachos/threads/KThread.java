...
public class KThread 
{
    ...
    public KThread()
    {
    	...
    	else
    	{
    		...
    		currentThread = this;
    		tcb = TCB.currentTCB();
    		name = "main";//this is de main jajajajajaj
    		restoreState();
    		createIdleThread();
    	}
    }//KThread
    ...
    public void join() 
    {
    	...
    	boolean intStatus=Machine.interrupt().disable();//desabilita interrupciones
    	if(joinQueue==null)
    	{
    		//se crea una cola para guardar los threads joined
    		//la cola de join debe transferir prioridad
    ...
    public static void selfTest2()
    {
        ...
        System.out.println("Entrando a ###33KThread.selfTest2()####33");
        Runnable myrunnable1=new Runnable()
        {
            public void run()
            {
                ...
                while(i<10)
                {
                    System.out.println("*** entrando a while1 loop "+ i +" ***");
                    i++;      
                }//while
            }//run
        };//Runnable
        ...
        Runnable myrunnable2=new Runnable()
        {
            public void run()
            {
                ...
                while(i<10)
                {
                    System.out.println("*** dentro while2 loop"+i+" ***");
                    i++;
                }//while   
            }//run()
        };//Runnable
        ...
        t2.fork();
        System.out.println("***haciendo t1.fork*****");
        testThread.fork();
        
        System.out.println("******haciendo t2 join****");
        t2.join();
        System.out.println("****dejando join********");
//yield add current thread to ready queue, and switch context
        yield();  
    }//selfTest2()
