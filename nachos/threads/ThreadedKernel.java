...
public class ThreadedKernel extends Kernel 
{
    ...
    {//inicializa este kernel, crea un calendarizador, crea el primer thread y una alarma y abilita interrupciones crea un file system si es necesario
	// set scheduler
	String schedulerName = Config.getString("ThreadedKernel.scheduler");
	scheduler = (Scheduler) Lib.constructObject(schedulerName);//construye un objeto y lo castea a un tipo Scheduler
