...
public class RoundRobinScheduler extends Scheduler {
     ...
     */
    public ThreadQueue newThreadQueue(boolean transferPriority) //recibe como parametro si hay prioridad o no
    {
    	return new FifoQueue();
    }

    private class FifoQueue extends ThreadQueue //extiende de ThreadQueue y es una FIFOQueue
    {
	/**
