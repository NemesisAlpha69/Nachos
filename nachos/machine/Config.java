...
public final class Config {
	...
	Lib.assertTrue(!loaded);//verifica si ha sido load
	loaded = true;//siendo loaded igual a true y si no existe exception
	
	configFile = fileName;///le da el nombre que esta en fileName
